...
@itinerisltd/wpom-cli/0.2.6 darwin-x64 node-v10.16.0
$ wpom --help [COMMAND]
USAGE
  $ wpom COMMAND
...
...
_See code: [src/commands/create.ts](https://github.com/itinerisltd/wpom-cli/blob/v0.2.6/src/commands/create.ts)_
...
_See code: [src/commands/stack/create.ts](https://github.com/itinerisltd/wpom-cli/blob/v0.2.6/src/commands/stack/create.ts)_
...
_See code: [src/commands/stack/info.ts](https://github.com/itinerisltd/wpom-cli/blob/v0.2.6/src/commands/stack/info.ts)_
<!-- commandsstop -->
